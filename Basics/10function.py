...
one of the tools that makes functions do this is adding parameters to them  inside the ()
'''
...
sum_2_numbers(44, 6)
sum_2_numbers()  # ---> this isnt work because 2
#  arguments been required to pass to the function
'''
now, you are asking with the hack is argument ?
